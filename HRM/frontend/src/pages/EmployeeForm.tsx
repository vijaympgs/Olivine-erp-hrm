...
// Tab Components
const IdentificationTab: React.FC<{ data: Record<string, any>; onChange: (field: string, value: any) => void; onCancel: () => void; loading?: boolean; errors?: Record<string, string>; hideButtons?: boolean }> = ({ data, onChange, onCancel, loading, errors, hideButtons }) => (
...
const PersonalTab: React.FC<{ data: Record<string, any>; onChange: (field: string, value: any) => void; onCancel: () => void; loading?: boolean; errors?: Record<string, string>; hideButtons?: boolean }> = ({ data, onChange, onCancel, loading, errors, hideButtons }) => (
<div className="space-y-6">
...
const ContactTab: React.FC<{ data: Record<string, any>; onChange: (field: string, value: any) => void; onCancel: () => void; loading?: boolean; errors?: Record<string, string>; hideButtons?: boolean }> = ({ data, onChange, onCancel, loading, errors, hideButtons }) => (
<div className="space-y-6">
...
const AddressTab: React.FC<{ data: Record<string, any>; onChange: (field: string, value: any) => void; onCancel: () => void; loading?: boolean; errors?: Record<string, string>; hideButtons?: boolean }> = ({ data, onChange, onCancel, loading, errors, hideButtons }) => (
<div className="space-y-6">
...
const EmploymentTab: React.FC<{ data: Record<string, any>; onChange: (field: string, value: any) => void; onCancel: () => void; loading?: boolean; errors?: Record<string, string>; hideButtons?: boolean }> = ({ data, onChange, onCancel, loading, errors, hideButtons }) => (
<div className="space-y-6">
...
const PositionTab: React.FC<{ data: Record<string, any>; onChange: (field: string, value: any) => void; onCancel: () => void; loading?: boolean; errors?: Record<string, string>; hideButtons?: boolean }> = ({ data, onChange, onCancel, loading, errors, hideButtons }) => (
<div className="space-y-6">
...
const ManagerTab: React.FC<{ data: Record<string, any>; onChange: (field: string, value: any) => void; onCancel: () => void; loading?: boolean; errors?: Record<string, string>; hideButtons?: boolean }> = ({ data, onChange, onCancel, loading, errors, hideButtons }) => (
<div className="space-y-6">
...
const CompensationTab: React.FC<{ data: Record<string, any>; onChange: (field: string, value: any) => void; onCancel: () => void; loading?: boolean; errors?: Record<string, string>; hideButtons?: boolean }> = ({ data, onChange, onCancel, loading, errors, hideButtons }) => (
<div className="space-y-6">
...
const BenefitsTab: React.FC<{ data: Record<string, any>; onChange: (field: string, value: any) => void; onCancel: () => void; loading?: boolean; errors?: Record<string, string>; hideButtons?: boolean }> = ({ data, onChange, onCancel, loading, errors, hideButtons }) => (
<div className="space-y-6">
...
const EmergencyTab: React.FC<{ data: Record<string, any>; onChange: (field: string, value: any) => void; onCancel: () => void; loading?: boolean; errors?: Record<string, string>; hideButtons?: boolean }> = ({ data, onChange, onCancel, loading, errors, hideButtons }) => (
<div className="space-y-6">
...
const StatusTab: React.FC<{ data: Record<string, any>; onChange: (field: string, value: any) => void; onCancel: () => void; loading?: boolean; errors?: Record<string, string>; hideButtons?: boolean }> = ({ data, onChange, onCancel, loading, errors, hideButtons }) => (
<div className="space-y-6">
...
const SystemTab: React.FC<{ data: Record<string, any>; onChange: (field: string, value: any) => void; onCancel: () => void; loading?: boolean; errors?: Record<string, string>; hideButtons?: boolean }> = ({ data, onChange, onCancel, loading, errors, hideButtons }) => (
<div className="space-y-6">
