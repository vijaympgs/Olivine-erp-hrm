...
- Module Number: [X.Y] from the file path (e.g., HR\02.Employee Management\02.1 Employee Records.md = 02.1)
- Module Name: [MODULE_NAME] from the file name (e.g., 02.1 Employee Records.md = Employee Records)
...
1. Read BBP_Template_Reference.md completely first for the complete structure and design language standards
2. Read BBP_Autoretry_Prevention_Guide.md for autoretry and cutoff prevention rules
3. Read the existing target file (if exists) to understand current content
4. Review HR/Streamlined_HR_Structure.md for module context and numbering
...
## **EXAMPLE: EMPLOYEE RECORDS BBP PROMPT**

```
Create a BBP for HR\02.Employee Management\02.1 Employee Records.md using the BBP_Template_Reference.md as your comprehensive guide.

Module Details:
- Module Name: Employee Records
- Module Number: 02.1
- Module Type: Master
- Target File: HR\02.Employee Management\02.1 Employee Records.md

Context Requirements:
1. Read BBP_Template_Reference.md completely first for the complete structure and design language standards
2. Read the existing target file to understand current content
3. Review HR/Streamlined_HR_Structure.md for module context and numbering
4. Reference similar modules like 02.2 Organizational Chart for consistency patterns

Content Requirements:
1. Use the Master template format from BBP_Template_Reference.md
2. Focus on employee data management including:
   - Personal information (name, contact details, demographics, emergency contacts)
   - Job information (position, department, employment type, work location, reporting structure)
   - Compensation information (salary grade, pay rate, benefits eligibility, compensation package)
   - Document management (employment contracts, certifications, attachments, digital signatures)
   - Employment history (previous positions, promotions, transfers, salary history)
3. Include Django models with proper relationships, indexes, and constraints
4. Define comprehensive business rules for data validation, privacy compliance (GDPR), and data integrity
5. Specify detailed UI/UX requirements following the design language standards from the template
6. Include complete design system specifications (typography, colors, spacing, components)
7. Add security requirements for sensitive employee data, role-based access, and audit trails
8. Define integration points with payroll, benefits, timekeeping, and performance management systems
...
- Include comprehensive error handling and validation for employee data
...
- Ensure content is suitable for direct UI development implementation
- Maintain consistency with existing HR module BBP patterns
...
- Business rules must be clear and comprehensive for data governance
- Integration points must be clearly defined with complete API specifications
- Security requirements must address employee data privacy and compliance needs
```
...
- **Master/Transaction:** Use complete template with all sections
- **Dashboard:** Use simplified template (Purpose, Type, Functional Capture, UI/UX Spec)
- **Reports:** Use simplified template (Purpose, Type, Functional Capture, UI/UX Spec)
- **Config/Setup:** Use focused template (Purpose, Type, Core Models, Business Rules, UI/UX Spec)
