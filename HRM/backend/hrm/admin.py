...
from .models import (
    ...
    # Enrollment Models
    Enrollment, EnrollmentWaitlist, EnrollmentApproval, EnrollmentRule, EnrollmentTemplate,
    EnrollmentCourse, EnrollmentCourseSession
)
...
class DepartmentAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class OrganizationalUnitAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class PositionAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class EmployeePositionAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class CompanyAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class ContractTemplateAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class ContractPositionAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class ContractOrganizationalUnitAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class RatingScaleAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class RatingLevelAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class ReviewCycleAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class CalibrationSessionAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class RatingGuidelineAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class RatingDistributionAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class CourseAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class CourseContentAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class CourseSessionAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class InstructorAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class LearningPathAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class SalaryStructureAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class PayGradeAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class CompensationRangeAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class PayrollRunAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class PayrollCalculationAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class PayrollDisbursementAdmin(TableNameDisplayMixin, admin.ModelAdmin):
    list_display = ['id', 'payroll_run', 'employee']
    search_fields = ['payroll_run__run_number', 'employee__first_name']
    fieldsets = (
...
class PayrollScheduleAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class EarningCodeAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class JobLevelAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class MarketDataAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class JobPostingAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class JobApplicationAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class ApplicationQuestionAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class ScreeningProcessAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class BackgroundCheckAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class ApplicationAnswerAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class ApplicationDocumentAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class ApplicationCandidateAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class ScreeningCriteriaAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class ScreeningTemplateAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class BackgroundCheckProviderAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class OfferLetterAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class OfferLetterTemplateAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class OfferPositionAdmin(TableNameDisplayMixin, admin.ModelAdmin):
    list_display = ['id', 'position_code']
    search_fields = ['position_code']
    fieldsets = (
        ('Offer Position', {
...
class TimeEntryAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class ShiftAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class AttendancePolicyAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class AttendanceDeviceAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class TimesheetAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class AttendanceExceptionAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class TimesheetEntryAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class TimesheetApprovalAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class BadgeAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class BadgeAwardAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class BadgeNominationAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class RecognitionFeedAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class BadgeCategoryAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class TaxCalculationAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class TaxRateAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class TaxJurisdictionAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class TaxPayrollRunAdmin(TableNameDisplayMixin, admin.ModelAdmin):
    list_display = ['id']
    search_fields = []

@admin.register(TaxWithholding, site=tax_compliance_site)
class TaxWithholdingAdmin(TableNameDisplayMixin, admin.ModelAdmin):
...
class TaxExemptionAdmin(TableNameDisplayMixin, admin.ModelAdmin):
    list_display = ['id', 'employee']
    search_fields = ['employee__first_name']
    fieldsets = (
        ('Tax Exemption', {
...
# ============================================================================
# DEFAULT DJANGO ADMIN SITE - HRM MODELS (ORGANIZED BY FUNCTIONAL AREA)
# ============================================================================
