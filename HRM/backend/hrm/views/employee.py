...
class EmployeeRecordViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        # For development, use company code 'MINDRA' which matches the imported data
        # In production, this would be user.company.code
        company_code = getattr(user, 'company_code', 'MINDRA')
        print(f"DEBUG: Request User: {user}, Company Code: {company_code}, Params: {self.request.query_params}")
    ...
    def perform_update(self, serializer):
        ...
        serializer.save(updated_by_user=updated_by)
