...
def get_toolbar_config(request, menu_id):
    ...
    try:
        ...
        return JsonResponse({
            ...
            'menu_type': menu_item.view_type, # Core model uses view_type
            'app': menu_item.module_name, # Core model uses module_name
            'module': menu_item.module_name, # Core model uses module_name
