...
# Import Core Platform models (Unified Toolbar Configuration)
...
from .employee_profile import EmployeeProfile, EmployeeSkill, SkillCategory
...
__all__ = [
    ...
    'EmployeeProfile', 'EmployeeSkill', 'SkillCategory', 'EmployeeDocument',
