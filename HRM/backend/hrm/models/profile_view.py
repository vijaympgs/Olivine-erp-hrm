...
from .employee_profile import EmployeeProfile, EmployeeSkill as Skill
from .document import EmployeeDocument as Certification
from .course_catalog import CourseLearningPath as LearningPath

# Placeholders for missing models to allow views to load
...
class Aspiration(models.Model):
    employee = models.ForeignKey('hrm.EmployeeRecord', on_delete=models.CASCADE)
