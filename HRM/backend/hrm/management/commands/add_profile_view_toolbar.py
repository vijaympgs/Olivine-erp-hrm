    ...
    def handle(self, *args, **options):
        ...
        menu_item, created = ERPMenuItem.objects.update_or_create(
            ...
            defaults={
                ...
                'view_type': 'MASTER',  # Mapped from MST-M
                'toolbar_config': 'NRQFXVDIOLBUG',  # Standard master config
                'applicable_toolbar_config': 'NRQFXVDIOLBUG',
                'is_active': True
            }
        )
        ...
        self.stdout.write(f'   Module: {menu_item.module_name}')
        self.stdout.write(f'   Submodule: {menu_item.submodule}')
        self.stdout.write(f'   Menu Type: {menu_item.view_type}')
