...
from ..models.employee_profile import EmployeeProfile, EmployeeSkill
from ..models.document import EmployeeDocument
from ..models.employee import EmployeeRecord
from .employee_profile import EmployeeSkillSerializer, EmployeeDocumentSerializer
...
EmployeeProfileListSerializer = ProfileViewListSerializer
EmployeeProfileDetailSerializer = ProfileViewDetailSerializer
ProfileUpdateSerializer = EmployeeProfileSerializer
SkillEndorsementSerializer = ProfileEndorsementCreateSerializer

# Dummy Serializers for missing models to allow views to load
...
class ProfileSearchSerializer(serializers.Serializer):
    ...
    skill_category = serializers.CharField(required=False)
    proficiency_level = serializers.IntegerField(required=False)
    department = serializers.CharField(required=False)
    position_level = serializers.CharField(required=False)
...
class ProfileAnalyticsSerializer(serializers.Serializer):
    ...
    profiles_by_department = serializers.DictField()
    profiles_by_position_level = serializers.DictField()
    top_skills = serializers.ListField()
    skill_distribution = serializers.DictField()
    certification_trends = serializers.ListField()
    learning_path_completion = serializers.DictField()
