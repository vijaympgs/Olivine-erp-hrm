...
class RelatedNameFixer:
    def __init__(self, models_dir="HRM.backend.hrm/backend/hrm/models"):
...
def main():
    ...
    parser.add_argument('--models-dir', default='HRM.backend.hrm/backend/hrm/models', help='Models directory path')
