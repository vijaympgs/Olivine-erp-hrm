...
from HRM.backend.hrm.views.admin_index import admin_index_view
from HRM.backend.hrm.views.toolbar_config import get_toolbar_config
...
urlpatterns = [
    ...
    path('api/hrm/', include('HRM.backend.hrm.urls.organization_urls')),
